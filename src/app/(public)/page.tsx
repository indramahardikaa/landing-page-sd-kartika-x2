...
import { FiBookOpen, FiUsers, FiAward, FiArrowRight, FiStar, FiHeart, FiMapPin } from "react-icons/fi"
...
export default async function HomePage() {
  ...
  const extracurriculars = await prisma.extracurricular.findMany({ take: 6 })

  return (
    <>
      {/* Hero Section - Colorful & Child-Friendly */}
      <section className="relative min-h-[650px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center pt-8">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 max-w-3xl mx-auto shadow-2xl border-4 border-yellow-400">
            ...
            <p className="text-green-600 font-bold text-lg mb-6 flex items-center justify-center gap-2">
              <FiStar className="text-yellow-500" /> Cerdas! Berkarakter! Berprestasi! <FiStar className="text-yellow-500" />
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/profil" className="bg-green-600 text-white px-8 py-3 rounded-full font-bold hover:bg-green-700 transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                Tentang Sekolah
              </Link>
              <Link href="/ppdb" className="bg-red-500 text-white px-8 py-3 rounded-full font-bold hover:bg-red-600 transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 animate-pulse">
                Daftar PPDB 2025
              </Link>
            </div>
          </div>
      ...
      {/* Stats Section - Fun Cards */}
      <section className="py-12 bg-white relative -mt-12 z-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 text-center border-2 border-green-200 shadow-sm hover:shadow-md transition transform hover:-translate-y-1">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-6 text-center border-2 border-yellow-200 shadow-sm hover:shadow-md transition transform hover:-translate-y-1">
              <div className="text-4xl mb-2">&#128105;&#8205;&#127979;</div>
              <h3 className="text-2xl font-extrabold text-yellow-700">25+</h3>
              <p className="text-sm text-yellow-600 font-medium">Guru & Staff</p>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 text-center border-2 border-blue-200 shadow-sm hover:shadow-md transition transform hover:-translate-y-1">
              <div className="text-4xl mb-2">&#9917;</div>
              <h3 className="text-2xl font-extrabold text-blue-700">6+</h3>
              <p className="text-sm text-blue-600 font-medium">Ekstrakurikuler</p>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 text-center border-2 border-purple-200 shadow-sm hover:shadow-md transition transform hover:-translate-y-1">
              <div className="text-4xl mb-2">&#127979;</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-800 mb-6">
                Sekolah Yang <span className="text-green-600">Menyenangkan</span> Untuk Belajar
              </h2>
              <p className="text-gray-600 leading-relaxed mb-4 text-lg">
                SD Kartika X-2 berkomitmen memberikan pendidikan dasar yang berkualitas dengan suasana belajar yang hangat dan menyenangkan bagi setiap siswa.
              </p>
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-red-400 rounded-full flex items-center justify-center text-2xl shadow-lg">&#10084;&#65039;</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">Guru-guru terbaik yang siap membimbing putra-putri Anda dengan penuh kasih sayang</p>
          </div>
            ...
            {staff.map((s, i) => {
              ...
              return (
                <div key={s.id} className="text-center group">
                  ...
                  <p className="text-[10px] text-gray-500 mt-0.5 leading-tight">{s.position.split('/')[0]}</p>
                </div>
              )
            })}
          </div>
          <div className="text-center mt-8">
            <Link href="/guru-staff" className="inline-flex items-center gap-2 text-green-700 font-bold hover:text-green-800 bg-green-50 px-6 py-3 rounded-full hover:bg-green-100 transition">
      ...
      <section className="py-16 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-block bg-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-sm font-bold mb-4">
              &#127979; Fasilitas
            </div>
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-800 mb-3">Fasilitas Lengkap</h2>
            <p className="text-gray-500 max-w-xl mx-auto">Sarana dan prasarana yang mendukung proses belajar mengajar</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {facilities.map((f, i) => {
              const emojis = ['&#128218;', '&#128187;', '&#9978;', '&#9917;', '&#127963;', '&#127828;', '&#128214;', '&#127931;']
              return (
                <div key={f.id} className="bg-white rounded-2xl p-5 text-center shadow-sm border-2 border-gray-100 hover:border-blue-300 hover:shadow-lg transition group">
                  <div className="w-14 h-14 mx-auto bg-blue-100 rounded-xl flex items-center justify-center text-2xl mb-3 group-hover:scale-110 transition-transform" dangerouslySetInnerHTML={{__html: emojis[i % emojis.length]}} />
          ...
          <div className="text-center mt-8">
            <Link href="/fasilitas" className="inline-flex items-center gap-2 text-blue-700 font-bold hover:text-blue-800 bg-blue-50 px-6 py-3 rounded-full hover:bg-blue-100 transition">
              Lihat Semua Fasilitas <FiArrowRight />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-block bg-orange-100 text-orange-700 px-4 py-1.5 rounded-full text-sm font-bold mb-4">
              &#127942; Ekstrakurikuler
            </div>
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-800 mb-3">Kegiatan Seru!</h2>
            <p className="text-gray-500 max-w-xl mx-auto">Banyak pilihan kegiatan menarik untuk mengembangkan bakat dan minat</p>
          </div>
          ...
          <div className="text-center mt-8">
            <Link href="/ekstrakurikuler" className="inline-flex items-center gap-2 text-orange-700 font-bold hover:text-orange-800 bg-orange-50 px-6 py-3 rounded-full hover:bg-orange-100 transition">
              Lihat Semua Ekskul <FiArrowRight />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-green-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center max-w-3xl relative z-10">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
            ...
            <p className="bg-yellow-400 text-green-900 inline-block px-6 py-2 rounded-full font-bold">
              R.A. Kartini
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-green-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">Kabar terbaru dari kegiatan sekolah kami</p>
          </div>
              ...
              <article key={n.id} className="bg-white rounded-2xl shadow-sm overflow-hidden border-2 border-gray-100 hover:border-green-300 hover:shadow-xl transition group">
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Link href={`/berita/${n.id}`} className="text-sm text-green-700 font-bold hover:underline flex items-center gap-1">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-red-100 text-lg mb-8">
              PPDB Tahun Ajaran 2025/2026 sudah dibuka. Daftarkan putra-putri Anda sekarang!
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <div className="inline-block bg-gray-100 text-gray-700 px-4 py-1.5 rounded-full text-sm font-bold mb-4">
              &#128205; Lokasi Kami
            </div>
            <h2 className="text-3xl font-extrabold text-gray-800 mb-3">Temukan Kami</h2>
          </div>
          ...
          <div className="text-center mt-4">
            <p className="text-gray-500 flex items-center justify-center gap-2">
              ...
              Jl. Flamboyan No.2, Pesanggrahan, Jakarta Selatan
            </p>
          </div>
        </div>
      </section>
